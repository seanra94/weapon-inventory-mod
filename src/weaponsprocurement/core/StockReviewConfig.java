...
public final class StockReviewConfig {
    ...
    private static final String CONFIG_PATH = "data/config/weapons_procurement_stock.json";
    ...
    private static StockReviewConfig fromJson(JSONObject json) {
        ...
        int small = WeaponsProcurementConfig.desiredSmallWeaponCount(
                clampDesired(optInt(desiredDefaults, "smallWeapon", DEFAULT_SMALL_WEAPON_COUNT)));
        int medium = WeaponsProcurementConfig.desiredMediumWeaponCount(
                clampDesired(optInt(desiredDefaults, "mediumWeapon", DEFAULT_MEDIUM_WEAPON_COUNT)));
        int large = WeaponsProcurementConfig.desiredLargeWeaponCount(
                clampDesired(optInt(desiredDefaults, "largeWeapon", DEFAULT_LARGE_WEAPON_COUNT)));
        int fighterWing = WeaponsProcurementConfig.desiredFighterWingCount(
