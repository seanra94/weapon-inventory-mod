...
- Popup visual rules:
  ...
  - `Tariffs Paid` is the markup paid above true base weapon value for planned buys, with an average multiplier label such as `[4.0x]`. It uses the red/cancel fill when the markup is greater than zero and gray when zero.
