...
- Popup redraw rule:
  ...
  - `StockReviewExpansionState` owns category, item-type, item, and review-trade-group expansion maps. `StockReviewState` should stay focused on user-facing screen state such as sort/source/filter/scroll/warning baselines and delegate expansion changes there.
